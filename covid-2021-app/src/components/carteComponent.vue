<template>
  <div>
  <svg  version="1.1" id="Calque_1"  width=100% height=80%
        viewBox="0 0 597.6 760" overflow="visible" enable-background="new 0 0 597.6 670.7" xml:space="preserve">
<g>
	<path fill="#f5eaac" d="M503.3,105.4l-5,3.9l-3.1,0.1l-5.8-2.6l-4-3.3h-7.7l-1.4,3.1l-6.3,0.8l-3.9-8.1l-3.5,0.3v-3.5l-6.8-1.7
  ...
  <path fill="#d6d4d8" d="M335.6,1l-18.3,4.6l-15.4,4.8l-6.5,5.6v20.2l3.3,3.9l-3.1-1.9l-0.8,6.6l0.5,4.3l2.6,1.8l-4.2,1.6l-0.4,3.4
  ...
  <path fill="#ffd3d3" d="M328.3,131.8l-2.5,1.8l-10.3-2.5l-7.1,2.1l-6.3-1.3l-1.8-3.6l-4.4,10.6h-4.3l-2.7,2.8l2,6.6l4.2,7.4
  ...
  <path fill="#cfefb3" d="M422.4,215.5l-2.5,2.2l-3.301-1.5l-14.1,1.8l-5.6-12.3L392.8,201l-2.2,2.5l-2.8-9.3l-5-6.2l-4.1-1.7
  ...
  <path fill="#fdd5c5" d="M344.2,205.3l-10.3-0.8l3-1.7l0.6-3l-4.7-4.8l-0.8-3.5l-4.2-0.6l-3.1,1.9l-1.7-2.9l-2.1,3.1l-7.801,0.9l0,0
  ...
  <path fill="#d6d4d8" d="M342.6,304.3l-2.5,2.1l1.9,6l-1.9,2.7l-9.8,1.1l-3.899,6.7l0,0l1.199,4.4c2.801,1.8,5.601,3.6,8.301,5.5
  ...
  <path fill="#f5eaac" d="M326.4,322.9l-5.5-0.2l-3.101,0.9l-14.9-3l-2.1,2.8l-12.9,1.2l-3.1,3.2l-1.9-2.7l-6.5,1.2l-3-1.2l1.8-3.2
  ...
  <path fill="#f5eaac" d="M178.5,114l-6,2.6l-7.2-11.8l2.8-8.8l-1.2-3.1l-7.3-0.8l-2.8,2l-7.3,0.5l-12.8-5.2l-0.2,3.2l3.7,2l0.6,5.5
  ...
  />
  <path fill="#cfefb3" d="M114,161.8l-4,0.3l-12.1,10l-1-4.1l-4.5-2.9l-0.1-3.5l-5.1-8.8l-3.3-0.7l0.7-3.2l-3.4,0.4l-1.9,3.3l1.5-7.4
  ...
  <path fill="#d6d4d8" d="M144.2,225.8l-1.8,3.2l-14.7,0.5l-5.9,3.8l-0.4,6.7l-17.3,5.1l-5,4.9l2.7,6.9l6.8,1.2l2.3,2.2l5.5-4.1
  ...
  <path fill="#fdd5c5" d="M302,425.601l-7.6-6.801l-9,0.801l-0.8,5.699l-1.6,6l-5.1,3.601l0.8,4l-6.8,3.8l-5.3,7.2l-3.8,3.6l3,10.2
  ...
  <path fill="#cfefb3" d="M558.1,425.4l-6.8-0.3l-5.899-3.7l-0.9-7.4l-3.1-0.1L538.8,408l0,0l-6.8,1.3l-2.3,2.2l-8.7-3.899l-1.7,4.3
  ...
  <path fill="#f5eaac" d="M569.8,578.9l0.601-12l-2-10.2l-3.2-1.2l-2.601,2.3l0.5,19.5l-9.699-1.5l-3.9,5.5l-12.1,4.801l-0.9,3.199
  ...
  <g>
    ...
    <g>
	<text transform="matrix(1 0 0 1 0 700)" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="28">Cumul des vaccinations (2 doses) par région </text>
      <text transform="matrix(1 0 0 1 60 750)" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="28">Données actualisées chaque jour</text>

      <text x="403 " y="405" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Auvergne.vaccin}}</text>
      <text x="403 " y="275" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Bourgogne.vaccin}}</text>
      <text x="30 " y="200" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Bretagne.vaccin}}</text>
      <text x="250 " y="270" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Centre_Val.vaccin}}</text>
      <text x="450 " y="650" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Corse.vaccin}}</text>
      <text x="433 " y="160" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Grand_Est.vaccin}}</text>
      <text x="300 " y="80" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Hauts_de_France.vaccin}}</text>
      <text x="300 " y="170" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{IDF.vaccin}}</text>
      <text x="180 " y="150" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Normandie.vaccin}}</text>
      <text x="180 " y="390" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Nouvelle.vaccin}}</text>
      <text x="270 " y="510" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Occitanie.vaccin}}</text>
      <text x="120 " y="260" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Pays_de_Loire.vaccin}}</text>
      <text x="450 " y="510" font-weight="bold" fill="darkblue" font-family="'Arial'" font-size="29">{{Provence_Alpes.vaccin}}</text>
...
<script>
import serviceVaccin from 'src/service/serviceVaccins';
const servicevaccin = new serviceVaccin();
let today = new Date();
...
name: "carteComponent",
  data(){
  return{
    Auvergne: {"code":"84","vaccin":""},
    Bourgogne:{"code":"27","vaccin":""},
    Bretagne:{"code":"53","vaccin":""},
    Centre_Val:{"code":"24","vaccin":""},
    Corse:{"code":"94","vaccin":""},
    Grand_Est:{"code":"44","vaccin":""},
    Hauts_de_France:{"code":"32","vaccin":""},
    IDF:{"code":"11","vaccin":""},
    Normandie :{"code":"28","vaccin":""},
    Nouvelle :{"code":"75","vaccin":""},
    Occitanie : {"code":"76","vaccin":""},
    Pays_de_Loire :{"code":"52","vaccin":""},
    Provence_Alpes:{"code":"93","vaccin":""},
  }
  },
  async mounted(){
   let result = await servicevaccin.getInfoVaccinRegion();
    let infoVaccinList = result.data.split(/\r\n|\n/);
    let arrayInfoVaccin= [];
    infoVaccinList.forEach(e=>{
      arrayInfoVaccin.push(e.split(";"));
    });
    let arrayReduced =[ this.Auvergne.code,this.Bourgogne.code,this.Bretagne.code,this.Centre_Val.code,this.Corse.code,this.Grand_Est.code,this.Hauts_de_France.code,
      this.IDF.code,this.Normandie.code ,this.Nouvelle.code , this.Occitanie.code,this.Pays_de_Loire.code,
      this.Provence_Alpes.code].reduce((a,e)=>{ return a.concat(arrayInfoVaccin.filter(c=> c[0]==e && c[1]==0 && c[2] == today))},[]);
    if(arrayReduced.lenght == 0){
      let yesterday = new Date();
      let dd2 = String(today.getDate()-2).padStart(2, '0');
      yesterday =yyyy+'-'+mm+'-'+dd2;
      arrayReduced =[ this.Auvergne.code,this.Bourgogne.code,this.Bretagne.code,this.Centre_Val.code,this.Corse.code,this.Grand_Est.code,this.Hauts_de_France.code,
        this.IDF.code,this.Normandie.code ,this.Nouvelle.code , this.Occitanie.code,this.Pays_de_Loire.code,
        this.Provence_Alpes.code].reduce((a,e)=>{ return a.concat(arrayInfoVaccin.filter(c=> c[0]==e && c[1]==0 && c[2] == yesterday))},[]);

    }
    let i =0;
    [this.Auvergne,this.Bourgogne,this.Bretagne,this.Centre_Val,this.Corse,this.Grand_Est,this.Hauts_de_France,
      this.IDF,this.Normandie ,this.Nouvelle, this.Occitanie,this.Pays_de_Loire,
      this.Provence_Alpes].forEach(e=>{
        console.log()
        e.vaccin = arrayReduced[i][6];
        i++;
      }
    )
  }
